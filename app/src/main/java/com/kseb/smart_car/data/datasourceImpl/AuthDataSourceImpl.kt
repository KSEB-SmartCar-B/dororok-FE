...
class AuthDataSourceImpl @Inject constructor(
    ...
    override suspend fun getPlacesDetail(
        token: String,
        contentId: String
    ): ResponseRecommendPlaceDetailDto = authService.getPlaceDetail(token,contentId)
    ...
    ): ResponseSaveFavoritePlaceDto = authService.deleteFavoritePlaceList(token,requestDeletePlaceListDto)
    ...
    ): ResponseFavoriteMusicStringDto = authService.deleteFavoritesMusicList(token,requestDeleteMusicListDto)
